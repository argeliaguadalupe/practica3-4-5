...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2024 a las 02:17:51
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `RealizarPedido` (IN `p_ClienteID` INT, IN `p_ProductoID` INT, IN `p_Cantidad` INT)   BEGIN
    ...
    IF v_StockActual >= p_Cantidad THEN
        ...
        VALUES (p_ClienteID, p_ProductoID, p_Cantidad, CURDATE());
